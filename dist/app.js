...
const programYearPositions_1 = __importDefault(require("./routes/programYearPositions"));
...
app.use(parties_1.default);
app.use(positions_1.default);
app.use(programYearPositions_1.default);
app.use(delegates_1.default);
